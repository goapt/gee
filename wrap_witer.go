...
// NewWrapResponseWriter wraps a http.ResponseWriter, returning a proxy that allows you to
...
// NewWrapResponseWriter2 wraps a http.ResponseWriter, http2
func NewWrapResponseWriter2(w http.ResponseWriter) WrapResponseWriter {
	_, fl := w.(http.Flusher)
...
// WrapResponseWriter is a proxy around a http.ResponseWriter that allows you to hook
